<?php
	if (isset($_POST['submit'])) {
		...
		$to = "accounts@breakoutscaff.com.au";
		...
		$email_body = "You have received a new message from Breakout Scaffolding website contact form.\n\nHere is the Details: \n\nName: $fullname \nEmail: $email \nPhone: $phone \nMessage: $message";
		...
		if ($mail) {
			...
			echo "<script>
					...
					window.location.href='https://b2bwebdevelopment.com.au/breakoutscaffolding/contact-us.html';
					</script>";
			// exit php
			exit;
		} else {
